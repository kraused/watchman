...
static char **_fill_argv()
{
	...
	strcpy(_producer[5], "tests/test07.copy");
...
class Test07_Program : public Program
{
...
class Test07_Plugin : public Watchman_Plugin
{

public:
				explicit Test07_Plugin(void *handle, int version);
...
Test07_Program::Test07_Program()
: Program(_fill_argv())
{
}

Test07_Plugin::Test07_Plugin(void *handle, int version)
: Watchman_Plugin(handle, version), _fo(nullptr), _fe(nullptr)
{
}

int Test07_Plugin::init(Watchman *w, int argc, char **argv)
{
	int err;
...
extern "C" Watchman_Plugin *entry(void *handle, Watchman *w)
{
	...
	return alloc->create<Test07_Plugin>(handle, 1);
}
